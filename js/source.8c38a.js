...
/* harmony import */ var _components_Scheduler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(138);
var _dec, _class;
...
let App = (_dec = Object(react_hot_loader__WEBPACK_IMPORTED_MODULE_1__["hot"])(module), _dec(_class = class App extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  render() {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Scheduler__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], null));
  }
...
class Task_Task extends react["PureComponent"] {
  constructor(props) {
    ...
    this.getTaskStyles = () => {
      return classnames_default()(styles_m_default.a.task, {
        [styles_m_default.a.completed]: this.props.completed
      });
    };

    this.getCheckboxStyles = () => {
      return classnames_default()(styles_m_default.a.toggleTaskCompletedState, {
        [styles_m_default.a.completed]: this.props.completed
      });
    };

    this._toggleTaskCompletedState = () => {
      this.props._updateTaskAsync(_objectSpread({}, this._getTaskShape(), {
        completed: !this.props.completed
      }));
    };
    ...
    this._setTaskEditingState = mode => {
      this.setState({
        isTaskEditing: mode
      }, () => {
        if (this.state.isTaskEditing) {
  ...
  render() {
    ...
    return react_default.a.createElement("li", {
      ...
      checked: completed,
      className: styles_m_default.a._toggleTaskCompletedState,
      color1: "#3b8ef3",
      color2: "#fff",
...
class Header_Header extends react["Component"] {
  ...
  render() {
    return react_default.a.createElement("header", null, react_default.a.createElement("h1", null, "Task Scheduler"), react_default.a.createElement("input", {
      placeholder: "Search",
      type: "text",
...
Header_Header.propTypes = {
  _updateTasksFilter: prop_types["func"].isRequired
};
...
// CONCATENATED MODULE: ./source/components/Composer/index.js
// Core



class Composer_Composer extends react["Component"] {
  constructor(...args) {
    super(...args);
    this.state = {
      message: ''
...
Composer_Composer.propTypes = {
  _createTask: prop_types["func"].isRequired
};
/* harmony default export */ var components_Composer = (Composer_Composer);
// EXTERNAL MODULE: ./source/components/Scheduler/styles.m.css
var Scheduler_styles_m = __webpack_require__(6);
...
const api = {
  ...
  createTask: async message => {
    const task = api_objectSpread({}, new helpers_BaseTaskModel(), {
      message
    });
    ...
    const response = await fetch(MAIN_URL, {
      ...
      body: JSON.stringify(api_objectSpread({}, task))
    });
    const {
      data: newTask
    } = await response.json();
  ...
  updateTask: async updatedTask => {
    const response = await fetch(MAIN_URL, {
      ...
      body: JSON.stringify([api_objectSpread({}, updatedTask)])
    });
    const {
      data: task
    } = await response.json();
  ...
  completeAllTasks: async tasks => {
    ...
    await Promise.all(ps); // const res = [];
...
class Scheduler_Scheduler extends react["Component"] {
  constructor(...args) {
    ...
    this._setTaskFetchingState = state => {
      this.setState({
    ...
    this._createTaskAsync = async message => {
      this._setTaskFetchingState(true);
    ...
    this._completeAllTasksAsync = async () => {
      ...
      await api.completeAllTasks(uncompletedTasks.map(task => Scheduler_objectSpread({}, task, {
        completed: true
      })));
      this.setState(({
        tasks
      }) => ({
        tasks: tasks.map(task => task.completed ? task : Scheduler_objectSpread({}, task, {
          completed: true
        })),
        isTasksFetching: false,
    ...
    this._updateTasksFilter = tasksFilter => {
      this.setState({
        tasksFilter
      }, () => this._renderTasks());
    };

    this._toggleTaskCompletedState = id => {
      let [updatedTask] = this.state.tasks.filter(task => task.id === id);
      updatedTask = Scheduler_objectSpread({}, updatedTask, {
    ...
    this._toggleTaskFavoriteState = id => {
      let [updatedTask] = this.state.tasks.filter(task => task.id === id);
      updatedTask = Scheduler_objectSpread({}, updatedTask, {
    ...
    this._getAllCompleted = () => {
      return !this.state.tasks.length ? false : !this.state.tasks.some(item => !item.completed);
    };
    ...
    this._renderTasks = () => {
      ...
      let tasksToDisplay = !tasksFilter ? tasks : tasks.filter(task => task.message.toLowerCase().startsWith(tasksFilter));
  ...
  render() {
    ...
    }), react_default.a.createElement("main", null, react_default.a.createElement(components_Header, {
      _updateTasksFilter: this._updateTasksFilter
    }), react_default.a.createElement("section", null, react_default.a.createElement(components_Composer, {
      _createTask: this._createTaskAsync
...
/* harmony import */ var _pages_App__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(134);
// Core
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.8c38a.js.map